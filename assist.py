...
NOT A VIOLATION: a greeting or "what can you do" -- answer warmly in one sentence and invite them to name a topic. Nor is a request to play music or video: that is a device feature, rule 3."""
